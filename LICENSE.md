...
This repository contains a monorepo with distinct licensing for different parts of the project.
...
For the full text of the Apache License, Version 2.0, please refer to the content below.
...
Apache License
   ...
   4. Redistribution. You may reproduce and distribute copies of the
      ...
      (d) If the Work includes a "NOTICE" text file as part of its
          ...
          where such third-party notices normally appear. The contents of
   ...
   APPENDIX: How to apply the Apache License to your work.
      ...
      include a file named NOTICE containing the applicable attribution
      notices and a copy of the License in your distribution.
