 ...
 */
export default function getEnvVar(ctx: import('vite').ConfigEnv, env: Record<string, string | undefined>): Record<string, string> {
    const isLocal = ctx.mode !== 'production' && !env.GITHUB_ACTIONS && !env.NETLIFY;
    ...
    let versionUrl = isLocal ? "https://www.youtube.com/watch?v=dQw4w9WgXcQ" // You know this
