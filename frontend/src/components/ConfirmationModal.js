            ...
            <div class="bg-gray-800 rounded-2xl p-6 w-full max-w-sm mx-4 text-center">
                <div class="w-12 h-12 rounded-full bg-gray-700 flex items-center justify-center mx-auto mb-4">
                    <i data-lucide="alert-triangle" class="w-6 h-6 ${
                      onConfirm ? "text-red-400" : "text-blue-400"
                    }"></i>
                </div>
                ...
                <div class="flex justify-stretch space-x-3">
                    ...
                    ${
                      onConfirm
                        ? `<button id="modal-confirm" class="flex-1 py-2.5 px-4 bg-red-600 hover:bg-red-700 text-white rounded-lg transition-colors">${t(
                            "common.confirm",
                          )}</button>`
                        : ""
                    }
