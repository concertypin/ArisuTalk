                ...
                <div class="p-4 border-b border-gray-600">
                    ...
                    ${data?.metadata ? `
                        <div class="text-xs text-gray-500">
                            채팅방: ${data.metadata.chatId || 'N/A'} | 
                            API: ${data.metadata.apiProvider || 'N/A'} | 
                ...
                <div class="divide-y divide-gray-600">
                    ${data?.personaInput ? `
                        <details class="group">
                            ...
                            <div class="p-3 bg-gray-800 text-xs">
                                <pre class="text-gray-300 overflow-x-auto">${JSON.stringify(data.personaInput, null, 2)}</pre>
                            </div>
                        </details>
                    ` : ''}
                    ...
                    ${data?.systemPrompt ? `
                        <details class="group">
                            ...
                            <div class="p-3 bg-gray-800 text-xs">
                                <pre class="text-gray-300 overflow-x-auto whitespace-pre-wrap">${JSON.stringify(data.systemPrompt, null, 2)}</pre>
                            </div>
                        </details>
                    ` : ''}
                    ...
                    ${data?.outputResponse ? `
                        <details class="group">
                            ...
                            <div class="p-3 bg-gray-800 text-xs">
                                <pre class="text-gray-300 overflow-x-auto">${JSON.stringify(data.outputResponse, null, 2)}</pre>
                            </div>
                        </details>
                    ` : ''}
                    ...
                    ${data?.parameters ? `
                        <details class="group">
                            ...
                            <div class="p-3 bg-gray-800 text-xs">
                                <pre class="text-gray-300 overflow-x-auto">${JSON.stringify(data.parameters, null, 2)}</pre>
                            </div>
                        </details>
                    ` : ''}
                    ...
                    ${data?.metadata ? `
                        <details class="group">
                            ...
                            <div class="p-3 bg-gray-800 text-xs">
                                <pre class="text-gray-300 overflow-x-auto">${JSON.stringify(data.metadata, null, 2)}</pre>
                            </div>
                        </details>
                    ` : ''}
                </div>
                    ...
                    <div class="flex justify-between items-center">
                        <div>
                            ...
                            <p class="text-gray-400 text-sm mt-1">
                                총 ${logCount}/${maxLogs}개의 로그 항목 | 
                                로그 수집: ${enableDebugLogs ? '활성화됨' : '비활성화됨'}
                            </p>
                        </div>
                ...
                <div class="flex-1 overflow-hidden">
                    ${logCount === 0 ? `
                        <div class="flex flex-col items-center justify-center h-full text-gray-400">
                            ...
                            <h3 class="text-lg font-medium mb-2">로그가 없습니다</h3>
