...
import {
	...
	clearAllBrowserData,
} from "./lib/utils/debug-utils";
import {
	dumpLocalStorageToJson,
	dumpIndexedDBToJson,
} from "./lib/utils/dev-tools";
import { isResetOnRefreshEnabled } from "./lib/stores/debugSettings";
...
const isDevelopmentServer = () => {
	...
	const isLocalhost =
		...
		hostname === "[::1]";
	const isDevPort =
		port === "5173" || port === "3000" || port === "8080" || port === "5174"; // 일반적인 개발 서버 포트
