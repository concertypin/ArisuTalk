export const en = {
    ...
    characterModalSlider: {
        ...
        tone: {
            description:
                "What kind of tone do they use when chatting with you?",
    ...
    confirm: {
        ...
        resetDataBackupWarning:
            "If you haven't backed up, you will lose all data.",
    ...
    settings: {
        ...
        selfIntroductionInfo:
            "Helps AI have conversations that suit you better.",
        ...
        autoSnapshotsInfo:
            "Automatically create snapshots when settings change.",
    ...
    modal: {
        ...
        characterCardNoAvatarImageError: {
            title: "Save Error",
            message:
                "A profile picture is required to save the character card.",
        },
    ...
    ui: {
        ...
        fileSizeExceededMessage:
            "'{{fileName}}' is too large. (Max {{sizeLimit}})",
        unsupportedFormat: "Unsupported Format",
        unsupportedFormatMessage:
            "'{{fileName}}' is not a supported file format.",
    ...
    openChat: {
        ...
        openChatAutoManagement:
            "AI automatically manages character entry and exit",
        charactersMoodBased:
            "Characters participate based on their mood and state",
        naturalConversation:
            "Natural conversation flow is automatically created",
    ...
    api: {
        ...
        invalidResponse:
            "Did not receive valid response from {{provider}} API.",
        ...
        profileGenerationError:
            "{{provider}} profile generation API call error:",
    ...
    hypnosis: {
        ...
        settingsWarning:
            "Hypnosis control overrides character's natural emotions",
        dangerousFeature:
    ...
    sns: {
        ...
        lockedContent:
            "🔒 A deeper relationship is needed to view this content",
    ...
    naiSettings: {
        ...
        batchGenerationDisabled:
            "⚠ API key must be set to use batch generation",
        batchGenerationHelp:
        ...
        helpDelay:
            "• 20-30 second wait time between generations to prevent abuse",
        helpAutoGeneration:
    ...
    naiHandlers: {
        ...
        generating: "Generating...",
        processingCharacter:
            "Processing {{character}}... ({{current}}/{{total}})",
        ...
        naiGenerationItemRemoved:
            "{{naiGenerationItem}} item has been removed.",
