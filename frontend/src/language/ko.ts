...
export const ko: LanguageStrings = {
  ...
  debugLogs: {
    ...
    promptLoadError: "프롬프트 파일을 불러올 수 없습니다. ({{chatType}})",
  },
  api: {
  ...
  sns: {
    ...
    tagsTab: "태그",
    addTag: "태그 추가",
    addTagPlaceholder: "태그 추가 (콤마로 구분)",
  ...
  naiSettings: {
    apiSettings: "NovelAI API 설정",
    apiKey: "API 키 (Persistent Token)",
    apiKeyPlaceholder: "NovelAI API 키를 입력하세요",
    toggleApiKey: "API 키 보기/숨기기",
    apiKeySet: "API 키가 설정되었습니다: {{key}}",
    apiKeyRequired: "API 키가 필요합니다",
    getApiKeyHint: "NovelAI 계정 설정에서 Persistent API Token을 발급받으세요",
    modelSettings: "모델 및 생성 설정",
    model: "NovelAI 모델",
    modelSupportsCharacterPrompts: "v4/v4.5 모델은 캐릭터 프롬프트를 지원합니다",
    imageSize: "이미지 크기",
    sizeSquare: "정사각형 (1024×1024) - 권장",
    sizePortrait: "세로형 (832×1216)",
    sizeLandscape: "가로형 (1216×832)",
    unlimitedGeneration: "✓ 모든 크기는 무제한 생성이 가능합니다",
    minDelaySeconds: "최소 대기 시간 (초)",
    minDelayDescription: "연속 생성 간 최소 대기 시간",
    additionalRandomSeconds: "추가 랜덤 시간 (초)",
    additionalRandomDescription: "최소 시간에 추가되는 랜덤 시간",
    generationSteps: "생성 스텝 수",
    promptGuidance: "프롬프트 가이던스",
    sampler: "샘플러",
    noiseSchedule: "노이즈 스케줄",
    characterImageSettings: "캐릭터 및 이미지 설정",
    useCharacterPrompts: "캐릭터 프롬프트 사용 (v4/v4.5 전용)",
    characterPromptsDescription: "특정 캐릭터를 일관성 있게 생성합니다",
    useVibeTransfer: "Vibe Transfer 사용",
    vibeTransferDescription: "참조 이미지를 기반으로 스타일을 적용합니다",
    referenceStrength: "참조 강도",
    informationExtraction: "정보 추출량",
    vibeImageUpload: "Vibe Transfer 이미지 업로드",
    imageUploadFormats: "JPG, PNG 파일 지원 (최대 2MB)",
    advancedSettings: "고급 설정",
    enableSMEA: "SMEA 활성화",
    smeaDescription: "Smooth Mode Enhanced Annealing - 고해상도에서 일관성 향상",
    enableSMEADYN: "SMEA DYN 활성화",
    smeaDynDescription: "Dynamic SMEA - 부드러운 효과 없이 일관성만 향상",
    cfgRescale: "CFG Rescale",
    unconditionalScale: "Unconditional Scale",
    dynamicThresholding: "동적 임계값 (Dynamic Thresholding)",
    dynamicThresholdingDescription: "높은 CFG 값에서의 색상 왜곡을 방지합니다",
  },
  stickerProgress: {
    title: "{{name}} 스티커 생성 중...",
    ...
    currentStatus: "현재 상태",
    emotionsToGenerate: "생성할 감정 스티커",
    completedStickers: "생성 완료된 스티커",
    waitingMessage: "API 제한으로 인해 {{seconds}}초 대기 중...",
    retry: "재시도",
    completed: "완료",
    close: "닫기",
    statuses: {
      generating: "{{emotion}} 스티커 생성 중...",
      completed: "모든 스티커 생성이 완료되었습니다!",
      error: "스티커 생성 중 오류가 발생했습니다.",
      waiting: "API 제한으로 인해 대기 중...",
      preparing: "스티커 생성을 준비하고 있습니다..."
    },
    emotions: {
      happy: "행복",
      sad: "슬픔",
  ...
  naiHandlers: {
    ...
    processedCharacters: "처리된 캐릭터: {{count}}개",
