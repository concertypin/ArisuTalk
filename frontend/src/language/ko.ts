...
export const ko: LanguageStrings = {
  ...
  sns: {
    ...
    secretsTab: "비밀글",
    tagsTab: "태그",
    noPostsAvailable: "아직 게시물이 없습니다",
    noSecretsAvailable: "아직 비밀글이 없습니다",
    noTagsAvailable: "아직 태그가 없습니다",
    secrets: "비밀글",
    tags: "태그",
    secretPostsWarning: "비밀글은 특별한 관계에서만 볼 수 있습니다",
    tagsDescription: "게시물에서 사용된 모든 태그들",
    accessDenied: "이 콘텐츠에 접근할 권한이 없습니다",
    accessDeniedDescription: "더 높은 호감도나 특별한 권한이 필요합니다",
    ...
    hypnosisOverride: "최면 권한으로 접근",
    mainAccount: "메인 계정",
    secretAccount: "비밀 계정",
    secretAccountWarning: "이 계정은 극도로 개인적인 내용을 포함합니다",
    post: "게시물",
    posts: "게시물",
    memory: "추억",
    memories: "추억",
    ...
    accessLevel: {
      public: "공개",
      private: "비공개",
      secretPublic: "비밀계정 공개",
      secretPrivate: "비밀계정 비공개"
    },
    characterList: {
    ...
    importance: "중요도",
    mainPublic: "공개",
    mainPublicDesc: "모두가 볼 수 있음",
    mainPrivate: "비공개", 
    mainPrivateDesc: "친한 사람만",
    secretPublic: "뒷계정 공개",
    secretPublicDesc: "뒷계정 접근자만",
    secretPrivate: "뒷계정 비공개",
    secretPrivateDesc: "특별한 관계만",
    postCreated: "SNS 포스트 생성 완료",
    postCreationFailed: "SNS 포스트 생성 실패",
    postCreationError: "SNS 포스트 생성 중 오류: {{error}}"
  },
  nai: {
    stickerCreated: "NAI 스티커 생성 완료",
    stickerGenerationFailed: "NAI 스티커 생성 실패",
    stickerGenerationError: "NAI 스티커 생성 중 오류: {{error}}",
    apiKeyNotSet: "NAI API 키가 설정되지 않았습니다"
  },
  hypnosis: {
