...
const koAuth: LanguageStrings["auth"] = {
	signIn: "로그인",
	signOut: "로그아웃",
...
const koCharacterModal: LanguageStrings["characterModal"] = {
...
const koPhonebook: LanguageStrings["phonebook"] = {
	title: "커뮤니티 전화번호부",
	...
	retry: "다시 시도",
	close: "닫기",
	empty: "아직 게시된 캐릭터가 없습니다.",
	encrypted: "암호화됨",
	byAuthor: "{{author}} 작성",
	downloads: "다운로드: {{count}}",
	uploaded: "업로드: {{date}}",
	import: "가져오기",
	importing: "가져오는 중...",
};
...
const koReplaceHooks: LanguageStrings["modal"]["replaceHooks"] = {
	...
	inputType: "입력",
	inputDesc: "사용자가 입력한 메시지를 저장하기 전에 변환합니다.",

	outputType: "출력",
	outputDesc: "AI가 생성한 응답을 저장하기 전에 변환합니다.",

	requestType: "요청",
	requestDesc:
		"API에 요청을 보낼 때만 메시지를 변환합니다. 화면에는 표시되지 않습니다.",

	displayType: "표시",
	displayDesc:
		"화면에 표시할 때만 메시지를 변환합니다. 저장되는 데이터는 변경되지 않습니다.",
	addHook: "훅 추가",

	noHooks: "설정된 훅이 없습니다. 새 훅을 추가해보세요.",
	noRules: "규칙이 없습니다. 텍스트 변환 동작을 정의하려면 규칙을 추가하세요.",
	newHook: "새 훅",
	hookName: "훅 이름",
...
const koStickerProgress: LanguageStrings["stickerProgress"] = {
	title: "스티커 생성 진행 상황",
...
const koNaiHandlers: LanguageStrings["naiHandlers"] = {
...
const koNaiSettings: LanguageStrings["naiSettings"] = {
...
const koSNS: LanguageStrings["sns"] = {
...
const koHypnosis: LanguageStrings["hypnosis"] = {
...
const koSecurity: LanguageStrings["security"] = {
...
const koSystem: LanguageStrings["system"] = {
...
const koAPI: LanguageStrings["api"] = {
...
const koDataBrowser: LanguageStrings["dataBrowser"] = {
	title: "데이터 브라우저",
...
const koDebugLogs: LanguageStrings["debugLogs"] = {
...
const koDebug: LanguageStrings["debug"] = {
	quickPanel: {
		title: "디버그 퀵 패널",
		resetOnRefresh: {
			title: "새로고침 시 초기화",
...
const koGroupChat: LanguageStrings["groupChat"] = {
	groupChat: "단톡방",
...
const koOpenChat: LanguageStrings["openChat"] = {
	openChat: "오픈톡방",
...
const koChat: LanguageStrings["chat"] = {
...
const koModal: LanguageStrings["modal"] = {
	replaceHooks: koReplaceHooks,
	noSpaceError: {
		title: "저장 공간 부족",
		message:
...
const koDefaultCharacter: LanguageStrings["defaultCharacter"] = {
	name: "한서연",
};
const koSidebar: LanguageStrings["sidebar"] = {
	characters: "연락처 목록",
...
const koSettings: LanguageStrings["settings"] = {
	restore: "복원",
	delete: "삭제",
	...
	selfIntroductionInfo: "AI가 당신에게 맞는 대화를 할 수 있도록 도움을 줍니다.",
	...
	animationComingSoon: "애니메이션 설정은 향후 업데이트에서 지원될 예정입니다.",
	debug: "디버그",
	...
	warningNote: "주의사항",
	experimentalComingSoon: "실험적 기능은 향후 업데이트에서 추가될 예정입니다.",
...
const koPromptModal: LanguageStrings["promptModal"] = {
	title: "프롬프트 수정",
	promptsTab: "프롬프트",
	replaceHooksTab: "교체 훅",
...
const koMainChat: LanguageStrings["mainChat"] = {
	uploadPhoto: "사진 업로드",
	addCaption: "캡션 추가...",
...
const koConfirm: LanguageStrings["confirm"] = {
	cancel: "취소",
	confirm: "확인",
	...
	resetDataComplete: "모든 데이터가 초기화되었습니다. 페이지를 새로고침합니다.",
...
const koGeneratingStatus: LanguageStrings["generatingStatus"] = {
	generating: "생성 중...",
};
const koSearch: LanguageStrings["search"] = {
	prompt: "이름으로 캐릭터를 검색해보세요.",
	noResults: "검색된 캐릭터가 없습니다.",
};
const koSecureStorage: LanguageStrings["secureStorage"] = {
...
export const ko: LanguageStrings = {
	common: koCommon,
	auth: koAuth,
	characterModal: koCharacterModal,
	phonebook: koPhonebook,
	characterModalSlider: koCharacterModalSlider,
	confirm: koConfirm,
	mainChat: koMainChat,
	promptModal: koPromptModal,
	settings: koSettings,
	sidebar: koSidebar,
	defaultCharacter: koDefaultCharacter,
	modal: koModal,
	ui: koUI,
	chat: koChat,
	openChat: koOpenChat,
	...
	debug: koDebug,
	debugLogs: koDebugLogs,
	dataBrowser: koDataBrowser,
	api: koAPI,
	system: koSystem,
	landing: {
		welcomeTitle: "아리스톡에 오신 것을 환환합니다",
		welcomeMessage:
	...
	security: koSecurity,
	secureStorage: koSecureStorage,
	search: koSearch,
	generatingStatus: koGeneratingStatus,
	hypnosis: koHypnosis,
	sns: koSNS,
	naiSettings: koNaiSettings,
	naiHandlers: koNaiHandlers,
	stickerProgress: koStickerProgress,
	stickerPreview: koStickerPreview,
} as const;
