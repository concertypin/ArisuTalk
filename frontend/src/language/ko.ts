export const ko = {
    ...
    settings: {
        ...
        uiScale: "UI 배율",
        uiScaleInfo:
            "UI 크기를 조정하면 텍스트, 버튼, 아이콘의 크기가 변경됩니다.",
        small: "작게",
        large: "크게",
        defaultSize: "기본",
    ...
    modal: {
        ...
        saveFailed: {
            title: "저장 실패",
            message:
                "데이터 저장에 실패했습니다. 브라우저 캐시를 정리해주세요.",
        },
        ...
        invalidProfileName: {
            message:
                "생성된 프로필에 유효하지 않거나 비어 있는 이름이 있습니다:",
        },
    ...
    api: {
        ...
        imageUnavailable:
            "(사용자가 이미지를 보냈지만 더 이상 사용할 수 없습니다)",
        ...
        invalidResponse:
            "{{provider}} API로부터 유효한 응답을 받지 못했습니다.",
        ...
        profileGenerationError:
            "{{provider}} 프로필 생성 API 호출 중 오류 발생:",
    ...
    naiSettings: {
        ...
        customPositivePlaceholder:
            "기본 프롬프트에 추가할 내용을 입력하세요...",
        ...
        helpImageSizes:
            "• 무제한 생성 크기만 지원: 1024×1024, 832×1216, 1216×832",
        helpDelay:
            "• 부정사용 방지를 위해 생성 간 20-30초 대기시간이 적용됩니다",
        helpAutoGeneration:
    ...
    naiHandlers: {
        ...
        naiGenerationItemRemoved:
            "{{naiGenerationItem}} 항목이 제거되었습니다.",
