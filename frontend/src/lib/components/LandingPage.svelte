...
<div
    id="landing-page"
    class="w-full h-full absolute top-0 left-0 flex flex-col items-center justify-center text-center p-4 bg-gray-950"
>
    <div class="max-w-md">
        {#if import.meta.env.DEV}
            <div
                class="w-24 h-24 bg-gradient-to-br from-orange-500 to-red-600 rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg"
            >
                <Wrench class="w-12 h-12 text-white" />
            </div>
            <h2 class="text-3xl font-bold text-white mb-3">
                {t("landing.debugModeTitle")}
            </h2>
            <p class="text-gray-400 leading-relaxed mb-8">
                {t("landing.debugModeMessage")}
            </p>
