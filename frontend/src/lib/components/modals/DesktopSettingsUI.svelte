<script>
    ...
    import APISettingsPanel from '../settings/panels/APISettingsPanel.svelte';
    import AdvancedSettingsPanel from '../settings/panels/AdvancedSettingsPanel.svelte';
    import AppearanceSettingsPanel from '../settings/panels/AppearanceSettingsPanel.svelte';
    import CharacterDefaultsPanel from '../settings/panels/CharacterDefaultsPanel.svelte';
    import DataManagementPanel from '../settings/panels/DataManagementPanel.svelte';
    import NAISettingsPanel from '../settings/panels/NAISettingsPanel.svelte';
    import DebugSettingsPanel from '../settings/panels/DebugSettingsPanel.svelte';
...
<div class="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4" on:click|self={handleClose}>
