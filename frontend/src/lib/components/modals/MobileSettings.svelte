<script>
  ...
  import NaiSettings from './settings/NaiSettings.svelte';
  import AppearanceSettings from './settings/AppearanceSettings.svelte';
  import CharacterDefaults from './settings/CharacterDefaults.svelte';
  import DataManagement from './settings/DataManagement.svelte';
  import AdvancedSettings from './settings/AdvancedSettings.svelte';
  import DebugSettings from './settings/DebugSettings.svelte';
  import PromptSettings from './settings/PromptSettings.svelte';
