...
<script>
  ...
  import PreviewTab from './sticker-preview-tabs/PreviewTab.svelte';
  import ExifTab from './sticker-preview-tabs/ExifTab.svelte';
  import RerollTab from './sticker-preview-tabs/RerollTab.svelte';
  import ActionsTab from './sticker-preview-tabs/ActionsTab.svelte';
