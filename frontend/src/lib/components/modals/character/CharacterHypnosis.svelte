...
<details class="group border-t border-gray-700/50 pt-4">
  ...
  <div class="pt-4 space-y-4">
    ...
    <div class="flex items-center justify-between">
      <label for="hypnosis-enabled" class="text-sm font-medium text-gray-300"
    ...
    >
      ...
      >
        <div class="flex flex-col">
          <label for="sns-edit-access" class="text-sm font-medium text-gray-300"
            >SNS 내용 편집 권한</label
          >
      ...
      >
        <div class="flex flex-col">
          <label
            ...
            class="text-sm font-medium text-gray-300">호감도 조작 활성화</label
          >
      ...
      <div class="border-t border-gray-700 pt-4 space-y-3">
        ...
        <div class="flex items-center justify-between">
          <label for="sns-full-access" class="text-sm font-medium text-gray-300"
