...
{#if $isCharacterModalVisible}
  ...
  >
    ...
    >
      ...
      >
        <h3 id="character-modal-title" class="text-xl font-semibold text-white">
          {isNew
        ...
        <div class="flex items-center gap-2">
          {#if !isNew}
            <button
              on:click={() => isSNSCharacterListModalVisible.set(true)}
      ...
      <div class="p-6 space-y-6 overflow-y-auto">
        ...
        <div class="flex items-center space-x-4">
          ...
          <div class="flex flex-col gap-2">
            ...
            {#if $auth.isSignedIn && $phonebookAccessState !== "disabled"}
              <button
            ...
            <div class="border-b border-gray-700/50 pb-6">
              ...
              >
                <span class="flex items-center"
                  ><MessageSquarePlus class="w-4 h-4 mr-2" />{t(
                ...
                >
                  <input
                    type="checkbox"
                    bind:checked={characterData.proactiveEnabled}
