...
{#if $isCreateOpenChatModalVisible}
    ...
    >
        <div
            ...
            aria-modal="true"
            tabindex="0"
            aria-labelledby="create-open-chat-title"
        ...
        >
            ...
            <div class="p-6 space-y-6 overflow-y-auto">
                <div>
                    <label
                        ...
                        >{t("openChat.openChatName")}</label
                    >
                    <input
                        id="open-chat-name"
                        bind:value={chatName}
                        type="text"
                        placeholder={t("openChat.openChatNamePlaceholder")}
                    ...
                    <div class="flex items-start space-x-3 mb-3">
                        ...
                        <div>
                            <h4 class="text-sm font-medium text-blue-300 mb-2">
                                {t("openChat.openChatInfo")}
                            </h4>
                            <ul class="text-xs text-gray-400 space-y-1.5 pl-1">
                                <li>
                                    • {t("openChat.openChatAutoManagement")}
                                </li>
            ...
            >
                ...
                >
                <button
                    on:click={createOpenChat}
                    class="flex-1 py-2.5 px-4 bg-green-600 hover:bg-green-700 text-white rounded-lg transition-colors text-center"
