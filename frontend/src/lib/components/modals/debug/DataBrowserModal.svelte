<script>
  ...
  function filterData() {
    ...
    let data = Array.isArray(store.data)
      ? [...store.data]
      : Object.entries(store.data).map(([key, value]) => ({ key, value }));
      ...
      <div class="p-6 border-b border-gray-600">
        ...
        >
          <div>
            ...
            <p class="text-gray-400 text-sm mt-1">
              {t("dataBrowser.subtitle", {
                defaultValue: "Browse and inspect application data stores",
              })}
            </p>
          </div>
          <div
          ...
          >
            ...
            <button
              on:click={() => isDataBrowserModalVisible.set(false)}
            ...
            <p class="text-sm text-center">
              {searchQuery
                ...
                : t("dataBrowser.selectDifferentStore", {
                    defaultValue: "Select a different data store",
                  })}
            </p>
          </div>
        {:else}
