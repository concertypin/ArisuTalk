...
{#if $isMasterPasswordModalVisible}
  ...
  >
    <div
      ...
      class="bg-gray-800 rounded-lg w-full max-w-lg"
        ...
        <div class="space-y-4">
            ...
            <div class="flex items-start gap-3">
              ...
              <div class="text-sm text-gray-300">
                <p class="font-medium text-blue-400 mb-1">
                  {t("security.whyEncryptionIsNeeded")}
                </p>
          ...
          <div>
            ...
            {#if passwordStrength.message}
              <div
                class="mt-2 text-xs {strengthColors[
                  Math.min(passwordStrength.strength, 3)
                ]}"
              >
                {t("security.passwordStrength.label")}
                {strengthText[Math.min(passwordStrength.strength, 3)]} - {passwordStrength.message}
              </div>
            {/if}
          </div>
          ...
          <div>
            ...
            <p class="text-xs text-gray-500 mt-1">
              {t("security.passwordHintWarning")}
            </p>
          </div>
