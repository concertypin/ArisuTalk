...
{#if $isDesktopSettingsModalVisible}
    <div
        class="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4 w-full h-full"
    ...
    >
        <div
            ...
            class="bg-gray-800 rounded-2xl w-full max-w-6xl h-full max-h-[90vh] flex flex-col shadow-2xl border border-gray-700"
            ...
            <div class="flex flex-1 min-h-0">
                ...
                <div class="w-80 border-r border-gray-700 flex flex-col">
                    <div class="p-4 border-b border-gray-700">
                        ...
                        >
                            {t("settings.settingsCategories")}
                        </h4>
                    </div>
                    <nav class="flex-1 p-4 space-y-2">
                        {#each navItems as item (item.id)}
                            <button
                                class="w-full text-left p-3 rounded-lg transition-all duration-200 flex items-start gap-3 {activePanel ===
                                item.id
            ...
            <div class="border-t border-gray-700 p-6 bg-gray-800/50">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex gap-3">
                        <button
                            on:click={handleClose}
                            class="px-6 py-2.5 bg-gray-700 hover:bg-gray-600 text-white rounded-lg transition-colors"
                        >
                            {t("settings.close")}
                        </button>
                        <button
