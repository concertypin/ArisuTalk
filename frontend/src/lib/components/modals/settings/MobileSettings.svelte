                ...
                <div class="flex-1 overflow-y-auto space-y-1 mt-[88px] px-4">
                    {#each menuItems as item}
                        <button
                            ...
                            class="group border-b border-gray-800 last:border-b-0 w-full text-left"
                        >
                            <div
                                class="flex items-center justify-between list-none py-4"
                            >
                                <span
                                    class="text-lg font-medium text-gray-200 flex items-center"
                                >
                                    <svelte:component
                                        this={item.icon}
