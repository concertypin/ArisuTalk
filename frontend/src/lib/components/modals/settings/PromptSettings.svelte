...
import { ArrowLeft, Download, RefreshCw, Save, Upload } from "lucide-svelte";
...
<div class="flex flex-col h-full relative">
    <header
        class="absolute top-0 left-0 right-0 px-6 py-4 bg-gray-900/80 flex items-center justify-between z-10"
        style="backdrop-filter: blur(20px); -webkit-backdrop-filter: blur(20px);"
    >
        <div class="flex items-center space-x-2">
            <button
                on:click={() => dispatch("back")}
                class="p-3 -ml-2 rounded-full hover:bg-gray-700"
            >
        ...
        <div class="flex items-center">
            <button
                on:click={handleSave}
                class="p-3 -mr-2 rounded-full hover:bg-gray-700 text-blue-400"
            >
                <Save class="h-6 w-6" />
            </button>
        </div>
    ...
    <div
        class="flex-1 overflow-y-auto mt-[88px] px-6 mx-4 bg-gray-900 rounded-t-2xl py-6 space-y-6"
    >
        ...
        <div class="border-t-2 border-gray-700 pt-6 space-y-3">
            <button
                ...
                class="w-full p-3 rounded-lg bg-gray-700/80 border border-gray-600 text-gray-300 hover:bg-gray-700 flex items-center justify-center gap-3"
            >
            ...
            <button
                ...
                class="w-full p-3 rounded-lg bg-red-600/20 border border-red-500 text-red-400 hover:bg-red-600/30 flex items-center justify-center gap-3"
            >
