<script>
  ...
  import { User, Badge, BrainCircuit, MessageSquarePlus, Shuffle, Users } from 'lucide-svelte';
...
<div class="space-y-6">
    ...
    <div class="bg-gray-700/30 rounded-xl p-6">
        ...
        <div class="space-y-4">
            <div>
                <label class="flex items-center text-sm font-medium text-gray-300 mb-2" for="settings-user-name">
            ...
            <div>
                <label class="flex items-center text-sm font-medium text-gray-300 mb-2" for="settings-user-desc">
                                ...
                                <div class="grid grid-cols-2 gap-3">
                                    <div>
                                        ...
                                        <input 
                                            ...
                                            max="1440"
                                            placeholder="30" 
                                            bind:value={$settings.randomMessageFrequencyMin}
                                    ...
                                    <div>
                                        ...
                                        <input 
                                            ...
                                            max="1440"
                                            placeholder="120" 
                                            bind:value={$settings.randomMessageFrequencyMax}
                                            class="w-full px-3 py-2 bg-gray-700 text-white rounded-lg border-0 focus:ring-2 focus:ring-blue-500/50 text-sm"
                                        >
                                    </div>
                                </div>
