      ...
      {#if hasAccess}
        ...
        <div class="flex border-b border-gray-800">
          <button
            ...
            class="flex-1 py-4 text-sm font-medium {activeTab === 'posts'
          ...
          <button
            ...
            class="flex-1 py-4 text-sm font-medium {activeTab === 'secrets'
              ? `text-${isSecretMode ? 'red' : 'pink'}-500 border-b-2 border-${isSecretMode ? 'red' : 'pink'}-500 bg-gray-800/50`
              : 'text-gray-400 hover:text-gray-300 hover:bg-gray-800/30'} transition-colors relative"
          >
            {t("sns.secretsTab")}
          ...
          <button
            ...
            class="flex-1 py-4 text-sm font-medium {activeTab === 'tags'
              ? `text-${isSecretMode ? 'red' : 'pink'}-500 border-b-2 border-${isSecretMode ? 'red' : 'pink'}-500 bg-gray-800/50`
              : 'text-gray-400 hover:text-gray-300 hover:bg-gray-800/30'} transition-colors relative"
          >
            {t("sns.tagsTab")}
            ...
            <div class="text-xs text-red-400 space-y-1">
              ...
              <div>
                {t("sns.requiresRomance", {
                  level: requirements.private.romantic_interest * 100,
                })}
              </div>
            </div>
          </div>
