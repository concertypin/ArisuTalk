...
<div class="space-y-6">
    ...
    <div class="bg-gray-700/30 rounded-xl p-6">
        ...
        <select bind:value={provider} on:change={handleProviderChange} class="w-full px-4 py-3 bg-gray-700 text-white rounded-xl border-0 focus:ring-2 focus:ring-blue-500/50 transition-all duration-200">
    ...
    <div class="bg-gray-700/30 rounded-xl p-6">
        ...
        <button on:click={() => isPromptModalVisible.set(true)} class="w-full py-3 px-4 bg-blue-600 hover:bg-blue-700 text-white rounded-xl transition-colors flex items-center justify-center gap-2">
            <Edit class="w-4 h-4" />
