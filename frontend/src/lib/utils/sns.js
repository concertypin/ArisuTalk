export const requirements = {
    'main-public': { affection: 0, intimacy: 0, trust: 0, romantic_interest: 0 },
    'main-private': { affection: 0.5, intimacy: 0.5, trust: 0.5, romantic_interest: 0 },
    'secret-public': { affection: 0.7, intimacy: 0.7, trust: 0.7, romantic_interest: 0.4 },
    'secret-private': { affection: 0.9, intimacy: 0.9, trust: 0.9, romantic_interest: 0.9 },
    public: { affection: 0, intimacy: 0, trust: 0, romantic_interest: 0 },
    private: { affection: 0.75, intimacy: 0.6, trust: 0.8, romantic_interest: 0.5 },
    secretPublic: { affection: 0.7, intimacy: 0.7, trust: 0.7, romantic_interest: 0.4 },
    secretPrivate: { affection: 0.9, intimacy: 0.9, trust: 0.9, romantic_interest: 0.9 }
  };
