...
export class SecureStorageManager {
    ...
    try {
      ...
      if (!hasExistingEncryption) {
        ...
        await this.setupEncryption(
          autoPassword,
          i18n.t("secureStorage.autoGeneratedHint"),
        );
      } else {
  ...
  async setupEncryption(masterPassword, hint = "") {
    try {
      ...
      throw new Error(i18n.t("secureStorage.setupEncryptionFailed"));
    }
  }
  ...
  async saveApiConfigs(apiConfigs) {
    if (!this.masterPassword) {
      console.warn(i18n.t("secureStorage.noMasterPasswordForEncryption"));
      return;
    }
    ...
    try {
      ...
      throw new Error(i18n.t("secureStorage.saveApiConfigsFailed"));
    }
  }
  ...
  async loadApiConfigs() {
    if (!this.masterPassword) {
      console.warn(i18n.t("secureStorage.noMasterPasswordForDecryption"));
      return {};
    }
    ...
    try {
      ...
      console.error(
        i18n.t("secureStorage.loadApiConfigsFailed"),
        error,
      );
      return {};
    }
